...
@RestController
@Validated
@RequestMapping("/feesamount")
public class FeesAmountController extends GenericController<FeesAmountDTO, Long> {

	@Autowired
	FeesAmountService _feesService;
...
//	}
	...
	@PostMapping("/save")
	public ResponseEntity<APiResponse<FeesAmountEntity>> filterStreamval(@RequestBody FeesAmountDTO dto) {

		FeesAmountEntity entity = _feesService.save(dto);
