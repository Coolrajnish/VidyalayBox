...
@RestController
@Validated
@RequestMapping("/feesinstallment")
public class FeesInstallmentController extends GenericController<FeesInstallmentDTO, Long> {

	@Autowired
	FeesInstallmentService _feesService;
...
//	}
	...
	@PostMapping("/save")
	public ResponseEntity<APiResponse<FeesInstallmentEntity>> filterStreamval(@RequestBody FeesInstallmentDTO dto) {

		FeesInstallmentEntity entity = _feesService.save(dto);
