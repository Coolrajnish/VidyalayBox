...
//
//@Service
//public class OrgAdminMapper implements IMapperNormal {
//    @Override
//    public GenericEntity dtoToEntity(GenericDTO genericDto, GenericEntity genericEntity){
//        OrgAdminEntity entity = genericEntity == null ? new OrgAdminEntity() : (OrgAdminEntity) genericEntity;
//
