...
@RestController
@Validated
@RequestMapping("/feesdiscount")
public class FeesDiscountController extends GenericController<FeesDiscountDTO, Long> {

	@Autowired
	FeesDiscountService _feesService;
...
//	}
	...
	@PostMapping("/save")
	public ResponseEntity<APiResponse<FeesDiscountEntity>> filterStreamval(@RequestBody FeesDiscountDTO dto) {

		FeesDiscountEntity entity = _feesService.save(dto);
