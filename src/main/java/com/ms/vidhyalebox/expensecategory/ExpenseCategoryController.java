...
public class ExpenseCategoryController extends GenericController<ExpenseCategoryDTO, Long> {

    private final  ExpenseCategoryserviceImpl _expenseService;

    public ExpenseCategoryController(ExpenseCategoryserviceImpl expenseService) {
