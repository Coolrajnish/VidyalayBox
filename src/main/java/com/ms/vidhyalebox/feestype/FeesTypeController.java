...
public class FeesTypeController extends GenericController<FeesTypeDTO, Long> {

	@Autowired
	FeesTypeService _feesService;
...
//	}
	...
	@PostMapping("/save")
	public ResponseEntity<APiResponse<FeesTypeEntity>> filterStreamval(@RequestBody FeesTypeDTO dto) {

		FeesTypeEntity entity = _feesService.save(dto);
